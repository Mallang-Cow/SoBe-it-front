...
export default function Register() {
  ...
  const { mutate: checkUserId } = useMutation(checkId, {
    // 아이디 중복 체크 API 연결
    onSuccess: (response) => {
  ...
  return (
    <div className="RootContainer">
      <Container component="main" style={{ width: "54rem" }}>
        ...
        <RegisterFormContainer style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <div style={{ width: "9.4rem" }}>
              <CheckButton fullWidth disabled={isIdVerified} onClick={checkIdVerified}>
                중복 확인
              </CheckButton>
            </div>
          </div>
          ...
          <InputTextField
            ...
            fullWidth
            value={passwordCheck}
            onChange={(e) => handleChange(e, setPasswordCheck)}
          />
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <div style={{ width: "9.4rem" }}>
              <CheckButton fullWidth onClick={smsRequest}>
                인증 요청
              </CheckButton>
            </div>
          </div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div style={{ width: "33.2rem" }}>
              <InputTextField
                ...
                onChange={(e) => handleChange(e, setAuthenticationNumber)}
              />
            </div>
            <div style={{ width: "9.4rem" }}>
              <CheckButton fullWidth onClick={smsOk} disabled={!isPhoneRequested}>
                인증 확인
              </CheckButton>
            </div>
          </div>
        ...
        <ButtonContainer>
          <RegisterButton variant="contained" fullWidth onClick={handleRegister} disabled={!isAuthenticated}>
            Register
          </RegisterButton>
        </ButtonContainer>
      </Container>
