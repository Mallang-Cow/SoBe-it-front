...
| 세부 역할 <br/> (Frontend) | · 피드 글 작성 폼 <br/> · 피드 무한 스크롤 <br/> · 게시글 검색 | · 게시글 <br/> · 상세 게시글 <br/> · 통계 <br/> · 도전 과제 | · 사용자 인증 및인가 <br/> · 알림 <br/> · 팔로잉/팔로워 <br/> · 사용자 검색  | · 메뉴 바 <br/> · 사이드 바 | · 프로필 <br/> · 도전 과제 |
...
- 로그인 시 `Sprint Security`와 `JWT`를 이용하여 Access Token을 발급받아 세션 스토리지에 저장한다.
...
- ‘지출 입력’ 타입과 ‘결재 받기’ 타입 모두 게시글 작성 시 이미지를 업로드할 수 있다.
    - Amazon S3 Service를 이용하여 이미지 업로드 기능을 구현했다.
